(ns marketentry.store
  "SSoT for the UGA market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems UG" :portal "e-GP/PPDA"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ug-entity? true :has-ug-entity? true
             :requires-ursb? true :ursb-verified? true
             :drafted? false :submitted? false
             :jurisdiction "UGA" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "e-GP/PPDA"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ug-entity? true :has-ug-entity? true
             :requires-ursb? true :ursb-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "e-GP/PPDA"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "UGA" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "e-GP/PPDA"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ug-entity? true :has-ug-entity? false
             :requires-ursb? true :ursb-verified? true
             :drafted? false :submitted? false
             :jurisdiction "UGA" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "e-GP/PPDA"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ug-entity? true :has-ug-entity? true
             :requires-ursb? true :ursb-verified? false
             :drafted? false :submitted? false
             :jurisdiction "UGA" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "e-GP/PPDA"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-ug-entity? has-ug-entity?
                               requires-ursb? ursb-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-ug-entity?)  (assoc :engagement/requires-ug-entity? requires-ug-entity?)
    (some? has-ug-entity?)       (assoc :engagement/has-ug-entity? has-ug-entity?)
    (some? requires-ursb?)    (assoc :engagement/requires-ursb? requires-ursb?)
    (some? ursb-verified?)    (assoc :engagement/ursb-verified? ursb-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-ug-entity? :engagement/has-ug-entity?
   :engagement/requires-ursb? :engagement/ursb-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-ug-entity? (boolean (:engagement/requires-ug-entity? m))
     :has-ug-entity? (boolean (:engagement/has-ug-entity? m))
     :requires-ursb? (boolean (:engagement/requires-ursb? m))
     :ursb-verified? (boolean (:engagement/ursb-verified? m))
